...
class PlayOfflineMenu(ui.UI):
    def __init__(self, screen):
        ...
        self.enemiesValue = label.Text([my.SCREEN_HALF_WIDTH + 50, 65], "5", fontsize=18)
        self.addWidget(self.enemiesValue)
        self.addWidget(label.Text([my.SCREEN_HALF_WIDTH - 10, 65], "Inimigos", fontsize=18))
        self.addWidget(
            slider.SliderBar(partial(self.sliderEnemies), [my.SCREEN_HALF_WIDTH, 100], (100, 5), min=1, max=10, step=1,
                             initial=5,
...
class OptionsMenu(ui.UI):
    def __init__(self, screen):
        ...
        self.addWidget(button.Drop(self, ['FULLSCREEN', '1920 x 1080', '1280 x 1080', '960 x 680', '660 x 480'],
